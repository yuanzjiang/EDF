...
class Config:
    ...
    # ['indigo bunting', 'ladybug', 'gossamer-winged butterfly', 'chickadee', 'small white', 'dung beetle', 'coucal', 'American robin', 'junco', 'jacamar']
    smallest = [14, 301, 326, 19, 324, 305, 91, 15, 13, 95]

    # ['Saharan horned viper', 'king penguin', 'flatworm', 'wing', 'missile', 'snowplow', 'overskirt', 'assault rifle', 'patio', 'sombrero', 'bubble']
    middle = [66, 145, 110, 908, 657, 803, 689, 413, 706, 808, 971]

    # ['tray', 'carbonara', 'prayer rug', 'pillow', 'hot pot', 'grille', 'dishcloth', 'pizza', 'manhole cover', 'car wheel']
    largest = [868, 959, 741, 721, 926, 581, 533, 963, 640, 479]

    cifar10 = [404, 136, 130, 283, 354, 252, 31, 339, 628, 864]

    birds_small_act = [14, 19, 91, 15, 13, 95, 10, 16, 20, 12]

    cars_large_act = [581, 535, 717, 817, 511, 436, 656, 757, 661, 751]

    dogs_medium_act = [193, 180, 227, 167, 246, 248, 224, 177, 269, 252]

    dogs_small_act = [239, 238, 247, 195, 151, 266, 157, 181, 154, 217]

    birds_large_act = [130, 140, 83, 142, 134, 139, 88, 90, 144, 21]

    cars_medium_act = [802, 660, 829, 627, 609, 575, 573, 867, 734, 408]

    fruit_large_act = [949, 957, 950, 942, 954, 951, 945, 943, 987, 948]
    ...
    dict = {
        ...
        "middle": middle,
        "largest": largest,
        'in1k_cifar10': cifar10,
        "birds_hard": birds_small_act,
        'cars_easy': cars_large_act,
        'dogs_easy': dogs_medium_act,
        'birds_easy': birds_large_act,
        'dogs_hard': dogs_small_act,
        'cars_hard': cars_medium_act,
        'fruit_large_act': fruit_large_act
    }
...
def get_imagenet_1k(args, train_data_path, val_data_path):
    class_map = None
    ...
    dst_train = datasets.ImageFolder(os.path.join(train_data_path, "train"), transform=transform)
    ...
    dst_test = datasets.ImageFolder(os.path.join(val_data_path, "val"), transform=transform)
